...
import com.example.lugares.utiles.ImagenUtiles
...
class AddLugarFragment : Fragment()
{
    ...
    private fun ubicaGPS(){
        ...
        if(ActivityCompat.checkSelfPermission(requireContext(),
            ...
            &&
                ...
                != PackageManager.PERMISSION_GRANTED){ // Si no tengo los permisos, entonces los pido
    ...
    private fun subeAudio() {
        ...
        if(audioUtiles.getAudioGrabado()) {
            ...
            } else { //Por alguna razon no hay archivo de audio
                subeImagen("")
            }
        }else{ //No tomo nota de audio
            subeImagen("")
        }
